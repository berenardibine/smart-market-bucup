...
import { Wheat, Sprout, Apple, Beef, Hammer, Sparkles } from 'lucide-react';
...
const subcategories = [
  { id: 'all', label: 'All Agriculture', icon: <Sparkles className="h-4 w-4" /> },
  { id: 'crops', label: 'Crops', icon: <Wheat className="h-4 w-4" /> },
  { id: 'fertilizers', label: 'Fertilizers', icon: <Sprout className="h-4 w-4" /> },
  { id: 'animal-products', label: 'Animal Products', icon: <Beef className="h-4 w-4" /> },
  { id: 'farm-tools', label: 'Farm Tools', icon: <Hammer className="h-4 w-4" /> },
];
