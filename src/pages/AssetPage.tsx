...
import { Car, Home, Map, Bike, Sofa, Sparkles } from 'lucide-react';
...
const subcategories = [
  { id: 'all', label: 'All Assets', icon: <Sparkles className="h-4 w-4" /> },
  { id: 'cars', label: 'Cars', icon: <Car className="h-4 w-4" /> },
  { id: 'motorcycles', label: 'Motorcycles', icon: <Bike className="h-4 w-4" /> },
  { id: 'houses', label: 'Houses', icon: <Home className="h-4 w-4" /> },
  { id: 'land', label: 'Land', icon: <Map className="h-4 w-4" /> },
