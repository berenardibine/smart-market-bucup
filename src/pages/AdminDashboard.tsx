...
const AdminDashboard = () => {
  ...
  const modules = [
    ...
    { id: 'filter-analytics', label: 'Filters', icon: Target, color: 'from-emerald-500 to-green-500', bg: 'bg-emerald-50 dark:bg-emerald-950/30', path: '/admin/filter-analytics', description: 'User filters' },
    ...
    { id: 'ads', label: 'Ads', icon: Megaphone, color: 'from-amber-500 to-yellow-500', bg: 'bg-amber-50 dark:bg-amber-950/30', path: '/admin/ads', description: 'Smart ads' },
  ];
